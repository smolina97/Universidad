...
public class TileBlock
{
    ...
    public byte[] getBytes(int[] pointers)
    {
        ...
        System.arraycopy(ArrayUtils.toByteArray(pointers[0]), 0, bytes, 0, 4);
        System.arraycopy(ArrayUtils.toByteArray(pointers[1]), 0, bytes, 0x4, 4);
        ...
        System.arraycopy(ArrayUtils.toByteArray(pointers[2]), 0, bytes, 0x24, 4);
        return bytes;
    }
