...
public class UnsignedNumberFormatterFactory extends DefaultFormatterFactory {
	public UnsignedNumberFormatterFactory(int bits) {
		super(new UnsignedNumberFormatter(bits));
	}
}
