...
public class UnsignedNumberEditor extends JSpinner.NumberEditor {
	public UnsignedNumberEditor(JSpinner spinner, int bits)   {
		super(spinner);
		JFormattedTextField tempField = getTextField();
		tempField.setEditable(true);
		tempField.setFormatterFactory(
			new UnsignedNumberFormatterFactory(bits)
		);
        }
}
